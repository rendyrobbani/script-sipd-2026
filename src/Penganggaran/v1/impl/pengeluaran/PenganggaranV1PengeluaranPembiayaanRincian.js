...
export class PenganggaranV1PengeluaranPembiayaanRincian extends PenganggaranV1API {
	...
	async sipdFindByIdUnit(idUnit) {
		return await new Promise(async (resolve, reject) => {
			...
			let url = `https://sipd-ri.kemendagri.go.id/api/renja/pembiayaan/listByIdUnit`;
			...
			opt.body.tipe_pembiayaan = "pengeluaran";
	...
	async espressoSaveAll(body) {
		return await new Promise(async (resolve, reject) => {
			let url = `${this.espressoHost()}/sipd/v1/penganggaran/pengeluaran/pembiayaan`;
