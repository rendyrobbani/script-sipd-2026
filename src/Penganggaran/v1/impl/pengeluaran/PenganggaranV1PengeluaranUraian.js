...
export class PenganggaranV1PengeluaranUraian extends PenganggaranV1API {

	constructor() {
		super();
		this._title = "data_penganggaran_pengeluaran_uraian";
	}

	async sipdFindAll(isAnggaran = 1) {
		return await new Promise(async (resolve, reject) => {
			let url = `https://sipd-ri.kemendagri.go.id/api/renja/subs_sub_bl/list`;
	...
	async espressoSaveAll(body) {
		return await new Promise(async (resolve, reject) => {
			let url = `${this.espressoHost()}/sipd/v1/penganggaran/pengeluaran/uraian`;
