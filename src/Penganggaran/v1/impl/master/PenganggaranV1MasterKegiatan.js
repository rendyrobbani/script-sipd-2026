...
export class PenganggaranV1MasterKegiatan extends PenganggaranV1API {

	constructor() {
		super();
		this._title = "penganggaran_master_kegiatan";
	}

	async sipdFindAll() {
		return await new Promise(async (resolve, reject) => {
			let url = `https://sipd-ri.kemendagri.go.id/api/master/giat/list`;
	...
	async espressoSaveAll(body) {
		return await new Promise(async (resolve, reject) => {
			let url = `${this.espressoHost()}/sipd/v1/penganggaran/master/kegiatan`;
