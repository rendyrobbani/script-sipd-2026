...
export class PenganggaranV1PenerimaanPembiayaanRincian extends PenganggaranV1API {
	...
	async sipdFindByIdUnit(idUnit) {
		return await new Promise(async (resolve, reject) => {
			...
			opt.body.tipe_pembiayaan = "penerimaan";
	...
	async espressoSaveAll(body) {
		return await new Promise(async (resolve, reject) => {
			let url = `${this.espressoHost()}/sipd/v1/penganggaran/penerimaan/pembiayaan`;
